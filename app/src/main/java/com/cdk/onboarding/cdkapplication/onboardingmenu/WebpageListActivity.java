...
public class WebpageListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(OnboardingMenuContent.ITEMS));
    }

    public class SimpleItemRecyclerViewAdapter
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {

        private final List<OnboardingMenuContent.MenuItem> mValues;

        public SimpleItemRecyclerViewAdapter(List<OnboardingMenuContent.MenuItem> items) {
            mValues = items;
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public OnboardingMenuContent.MenuItem mItem;
